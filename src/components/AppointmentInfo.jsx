...
const AppointmentInfo = ({item, onDeleteAppointment}) => {

  return (
    <li className="px-3 py-3 flex items-start" key={item.id}>
          <button type="button" onClick={() => onDeleteAppointment(item.id)}
          ...
          <div className="flex-grow">
            ...
            <div><b className="font-bold text-blue-500">Owner:</b> {item.ownerName}</div>
